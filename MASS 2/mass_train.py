...
class CustomScriptArguments(ScriptArguments):
    ...
    reference_mask_probability: float = field(
        default=0.35,
        metadata={"help": "Probability that each reference span is replaced by # placeholders."},
    )
...
if __name__ == "__main__":
    ...
    if script_args.use_reference_masking and script_args.num_masked_teacher_views < 1:
